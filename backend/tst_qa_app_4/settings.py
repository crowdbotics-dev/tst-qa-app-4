"""
Django settings for tst_qa_app_4 project.
...
ROOT_URLCONF = 'tst_qa_app_4.urls'
...
WSGI_APPLICATION = 'tst_qa_app_4.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_qa_app_4 API",
    "DESCRIPTION": "API documentation for tst_qa_app_4 App",
    "VERSION": "v1",
}
